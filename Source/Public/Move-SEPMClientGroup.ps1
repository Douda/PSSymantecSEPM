function Move-SEPMClientGroup {
    ...
    .EXAMPLE
        Move-SEPMClientGroup -ComputerName "MyComputer" -GroupName "My Company\EMEA\Workstations"

        Moves the computer MyComputer to the group My Company\EMEA\Workstations
    .EXAMPLE
        "MyComputer1","MyComputer2" | Move-SEPMClientGroup -GroupName "My Company\EMEA\Workstations"

        Moves the computers MyComputer1 and MyComputer2 to the group My Company\EMEA\Workstations via pipeline
    .EXAMPLE
        Move-SEPMClientGroup -ComputerName "MyComputer" -GroupName "My Company\EMEA\Workstations" -SkipCertificateCheck
    ...
    begin {
        ...
        $endpoint = Get-SEPMApiEndpoint -OperationName 'Move-SEPMClientGroup'
    ...
    process {
        ...
        $computer = Get-SEPMComputers -ComputerName $ComputerName | Select-Object -First 1
