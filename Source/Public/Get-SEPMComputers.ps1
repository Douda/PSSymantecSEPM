function Get-SEPMComputers {
    ...
    .EXAMPLE
        "MyComputer1","MyComputer2" | Get-SEPMComputers

        Gets computer details for the specified computer MyComputer via pipeline
    .EXAMPLE
        Get-SEPMComputers -ComputerName "MyComputer*"

        Gets computer details for all computer names starting by MyComputer
    .EXAMPLE
        Get-SEPMComputers -GroupName "My Company\EMEA\Workstations"

        Gets computer details for all computers in the specified group MyGroup
    .EXAMPLE
        Get-SEPMComputers -GroupName "My Company\EMEA\Workstations" -IncludeSubGroups
...
#>
    ...
    begin {
        ...
        $endpoint = Get-SEPMApiEndpoint -OperationName 'Get-SEPMComputers'
    }
