function Get-SEPMFileDetails {
    ...
    .EXAMPLE
        PS C:\PSSymantecSEPM> Get-SEPMFileDetails -FileID 12345678901234567890123456789
...
#>
    ...
    begin {
        ...
        $endpoint = Get-SEPMApiEndpoint -OperationName 'Get-SEPMFileDetails'
    }
