function Get-SEPMClientDefVersions {
    <#
    .SYNOPSIS
    ...
    .DESCRIPTION
        Gets a list of clients for a group by content version.
    .EXAMPLE
        PS C:\PSSymantecSEPM> Get-SEPMClientDefVersions
    ...
    .EXAMPLE
        PS C:\PSSymantecSEPM> $definitionVersions = Get-SEPMClientDefVersions
...
#>
    ...
    begin {
        ...
        $endpoint = Get-SEPMApiEndpoint -OperationName 'Get-SEPMClientDefVersions'
    }
