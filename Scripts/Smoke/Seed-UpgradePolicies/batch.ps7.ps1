# Smoke verification for UpgradePolicies seed (PS7)
# Usage: pwsh -NoProfile -File Scripts/Smoke/Seed-UpgradePolicies/batch.ps7.ps1
...
Write-Host "=== Smoke: Seed UpgradePolicies (PS7) ==="
...
Write-Host "`n=== Smoke: Seed UpgradePolicies (PS7) — ALL PASS ===" -ForegroundColor Green
