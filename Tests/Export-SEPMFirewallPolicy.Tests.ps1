...
Describe 'Export-SEPMFirewallPolicy' {
    BeforeAll {
    ...
    Context 'Policies sheet data' {
        BeforeAll {
            ...
            Export-SEPMFirewallPolicy -Path $script:polXlsxPath
    ...
    Context 'FirewallRules sheet data' {
        BeforeAll {
            ...
            Export-SEPMFirewallPolicy -Path $script:rulesXlsxPath
    ...
    Context 'PolicyAssignments sheet data' {
        BeforeAll {
            ...
            Export-SEPMFirewallPolicy -Path $script:assignXlsxPath
    ...
    Context 'Connections formatting' {
        BeforeAll {
            ...
            Export-SEPMFirewallPolicy -Path $script:connXlsxPath
    ...
    Context 'Truncation at 30 items' {
        BeforeAll {
            ...
            Export-SEPMFirewallPolicy -Path $script:truncXlsxPath
    ...
    Context 'Pipeline mode' {
        ...
        It 'accepts SEPM.PolicySnapshot via pipeline and writes XLSX' {
            ...
            $script:pipelineSnapshot | Export-SEPMFirewallPolicy -Path $xlsxPath
            $xlsxPath | Should -Exist
            $sheetNames = Get-ExcelSheetInfo -Path $xlsxPath | Select-Object -ExpandProperty Name
            $sheetNames | Should -Contain 'Policies'
            $sheetNames | Should -Contain 'FirewallRules'
        ...
        It 'accepts snapshot by parameter' {
            ...
            Export-SEPMFirewallPolicy -Path $xlsxPath -Snapshot $script:pipelineSnapshot
            $xlsxPath | Should -Exist
        ...
        It 'accepts Deserialized.SEPM.PolicySnapshot via pipeline' {
            ...
            $deserialized | Export-SEPMFirewallPolicy -Path $xlsxPath
            $xlsxPath | Should -Exist
            $sheetNames = Get-ExcelSheetInfo -Path $xlsxPath | Select-Object -ExpandProperty Name
            $sheetNames | Should -Contain 'Policies'
            $sheetNames | Should -Contain 'FirewallRules'
