...
Describe 'Get-SEPMClientInfectedStatus' {
    ...
    Context 'ComputerList parameter' {
        ...
        It 'filters by infected status from passed list without calling Get-SEPMComputers' {
            Mock Get-SEPMComputers -ModuleName PSSymantecSEPM { throw 'Get-SEPMComputers should not be called' }

            $result = Get-SEPMClientInfectedStatus -ComputerList $script:computerList
            $result.Count | Should -Be 2
            $result[0].computerName | Should -Be 'PC01'
            $result[1].computerName | Should -Be 'PC03'
        }
        ...
        It 'filters by clean status from passed list with -ComputerList -Clean' {
            ...
            $result = Get-SEPMClientInfectedStatus -ComputerList $script:computerList -Clean
            $result.Count | Should -Be 2
            $result[0].computerName | Should -Be 'PC02'
            $result[1].computerName | Should -Be 'PC04'
            $result[0].infected | Should -Be 0
        ...
        It 'returns empty when -ComputerList has no infected matches' {
            ...
            $result = Get-SEPMClientInfectedStatus -ComputerList $cleanOnly
            $result | Should -BeNullOrEmpty
        }
        ...
        It 'returns empty when -ComputerList -Clean has no clean matches' {
            ...
            $result = Get-SEPMClientInfectedStatus -ComputerList $infectedOnly -Clean
            $result | Should -BeNullOrEmpty
        }
        ...
        It 'preserves all properties from passed computer objects' {
            ...
            $result = Get-SEPMClientInfectedStatus -ComputerList $richList
