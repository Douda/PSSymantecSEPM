...
Describe 'Get-SEPMFileDetails' {
    ...
    Context 'happy path' {
        ...
        It 'returns file details with expected fields' {
            ...
            $result = Get-SEPMFileDetails -FileID 'CD02BC8E0A6606D53533F2428BB86D4E'
        ...
        It 'calls the correct API endpoint' {
            ...
            Get-SEPMFileDetails -FileID 'TEST123' | Out-Null
        ...
        It 'handles response with null fields gracefully' {
            ...
            $result = Get-SEPMFileDetails -FileID 'NULLTEST'
